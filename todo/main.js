...
if (date.getDay() == 1) {
  if (btnSwitch0.classList.contains("active")  && date.getHours() >= 22) {
...
if (date.getDay() == 2) {
  ...
  if (btnSwitch1.classList.contains("active") && date.getHours() >= 22) {
...
if (date.getDay() == 3) {
  ...
  if (btnSwitch2.classList.contains("active") && date.getHours() >= 22) {
...
if (date.getDay() == 4) {
  ...
  if (btnSwitch3.classList.contains("active") && date.getHours() >= 22) {
...
if (date.getDay() == 5) {
  ...
  if (btnSwitch4.classList.contains("active") && date.getHours() >= 22) {
...
if (date.getDay() == 6) {
  ...
  if (btnSwitch5.classList.contains("active") && date.getHours() >= 22) {
...
if (date.getDay() == 0) {
  ...
  if (btnSwitch6.classList.contains("active") && date.getHours() >= 22) {
